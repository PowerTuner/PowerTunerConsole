...
namespace PWT::CUI::LNX {
    class BlockQueueSchedulerContainer final: public QWidget {
        Q_OBJECT

    private:
        QVBoxLayout *lyt = nullptr;
        QList<BlockQueueSchedulerWidget *> blockDevList;

        void clearDevices();

    public:
        BlockQueueSchedulerContainer();
    ...
    signals:
        void deleteDevice(const QLayoutItem *itm);
    };
}
