...
namespace PWT::CUI::LNX::AMD {
    class DPMForcePerformanceLevelWidget final: public QWidget {
        Q_OBJECT

    private:
        ConsoleSelect *dpmPerfLevel = nullptr;
        ConsoleCheckbox *resetPowerLevels = nullptr;
        EngineClockSCLKWidget *engineClockSclkWidget = nullptr;
        int index;

    public:
        explicit DPMForcePerformanceLevelWidget(int idx);
