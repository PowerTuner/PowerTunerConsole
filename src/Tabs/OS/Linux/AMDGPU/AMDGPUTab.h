...
#include "Widgets/DPMForcePerformanceLevelWidget.h"
#include "Widgets/PowerDPMStateWidget.h"

namespace PWT::CUI::LNX::AMD {
    class AMDGPUTab final: public AddonTab {
    private:
        QPointer<DPMForcePerformanceLevelWidget> dpmForcePerfLevelWidget;
        QPointer<PowerDPMStateWidget> powerDpmStateWidget;
