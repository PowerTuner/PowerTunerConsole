...
namespace PWT::CUI::AMD {
    class CorePerformanceBoostWidget final: public QWidget {
        Q_OBJECT
    ...
    private:
        ...
        ConsoleSelect *boostAll = nullptr;
        ConsoleSelect *cpuSelect = nullptr;
        ConsoleSelect *cpuBoost = nullptr;
        QList<WData> data;
    ...
    private slots:
        void onBoostAllChanged(int idx);
        void onCPUSelectChanged(int idx) const;
        void onBoostChanged(int idx);
    };
}
