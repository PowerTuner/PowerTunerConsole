...
namespace PWT::CUI::AMD {
    class PStateWidget final: public QWidget {
        Q_OBJECT
    ...
    private:
        ...
        ConsoleSelect *pstateAll = nullptr;
        ConsoleSelect *cpuSelect = nullptr;
        ConsoleSelect *pstate = nullptr;
        QList<WData> data;
    ...
    private slots:
        void onPStateAllChanged(int idx);
        void onCPUSelectChanged(int idx) const;
        void onPStateChanged(int idx);
    };
}
