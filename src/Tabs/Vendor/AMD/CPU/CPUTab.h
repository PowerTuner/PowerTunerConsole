...
#include "Widgets/PStateWidget.h"
#include "Widgets/CorePerformanceBoostWidget.h"
#include "Widgets/CPPCWidget.h"

namespace PWT::CUI::AMD {
    class CPUTab final: public AddonTab {
    private:
        QPointer<PStateWidget> pstateWidget;
        QPointer<CorePerformanceBoostWidget> corePerformanceBoostWidget;
        QPointer<CPPCWidget> cppcGBox;
