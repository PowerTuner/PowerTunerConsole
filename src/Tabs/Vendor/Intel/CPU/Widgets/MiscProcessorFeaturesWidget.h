...
namespace PWT::CUI::INTEL {
    class MiscProcessorFeaturesWidget final: public QWidget {
    private:
        QPointer<ConsoleCheckbox> enhancedSpeedStep;
        QPointer<ConsoleCheckbox> disableTurboBoost;

    public:
        explicit MiscProcessorFeaturesWidget(const QSet<PWTS::Feature> &cpuFeatures);
