...
namespace PWT::CUI::INTEL {
    class PKGCSTConfigControlCU1CoreWidget final: public PKGCSTConfigControlCoreWidget {
        Q_OBJECT

    private:
        ConsoleSelect *pkgCStateLimit = nullptr;
        ConsoleSelect *maxCoreCState = nullptr;
        ...
        ConsoleCheckbox *pkgcAutodemotionEnable = nullptr;
        ConsoleCheckbox *pkgcUndemotionEnable = nullptr;
        ConsoleCheckbox *timedMwaitEnable = nullptr;

    public:
        PKGCSTConfigControlCU1CoreWidget();
