...
namespace PWT::CUI::INTEL {
    class TurboPowerCurrentWidget final: public QWidget {
        Q_OBJECT

    private:
        ConsoleSliderUnit *tdp = nullptr;
        ConsoleCheckbox *tdpEnable = nullptr;
        ConsoleSliderUnit *tdc = nullptr;
        ConsoleCheckbox *tdcEnable = nullptr;

    public:
        TurboPowerCurrentWidget();
