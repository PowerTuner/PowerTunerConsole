...
namespace PWT::CUI::INTEL {
    class FIVRControlWidget final: public QWidget {
    private:
        QPointer<ConsoleSliderUnit> cpu;
        QPointer<ConsoleSliderUnit> gpu;
        QPointer<ConsoleSliderUnit> cache;
        QPointer<ConsoleSliderUnit> sysAgent;
        QPointer<ConsoleSliderUnit> unslice;
