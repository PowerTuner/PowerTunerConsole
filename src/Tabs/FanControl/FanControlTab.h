...
#include "Widgets/FanControlWidget.h"
...
namespace PWT::CUI::FANS {
    ...
    private:
        QList<FanControlWidget *> fanControlList;
    ...
    private slots:
        void onAddPointToFocusList(const QWidget *wdg) const;
        void onRemovePoint(const QWidget *wdg) const;
    };
}
